 ...
 * Run: php database/migrations/001_initial_schema.php
 *
 * Creates all 13 tables for the Pricing & PRD Generator.
 * Idempotent: uses IF NOT EXISTS and CREATE TABLE IF NOT EXISTS.
 */
...
$stmt->execute(['m' => '001_initial_schema']);
if ($stmt->fetch()) {
...
");
echo "  Created: pricing_configs\n";

$db->exec("
    CREATE TABLE IF NOT EXISTS complexity_tiers (
        id INT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
...
");
echo "  Created: platform_multipliers\n";
...
");
echo "  Created: maintenance_settings\n";
...
");
echo "  Created: project_integrations\n";
...
");
echo "  Created: project_platforms\n";
